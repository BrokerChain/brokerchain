...
export async function rpc_watch_page_node_add<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_watch_page_node_add");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/x-brokerchain-dashboard/watch-page-node-add`,
                data: input
            },
            {
