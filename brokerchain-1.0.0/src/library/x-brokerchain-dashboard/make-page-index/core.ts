...
export async function core<R>(plog: Logger, input: Input, cb: Callback<R>): Promise<R> {
    const log = plog.sub("x-brokerchain-dashboard.make-page-index");
...
function make_path(log: Logger) {
    const entry_module_path_abs = dir.resolve(__dirname, "../_page-index/index.js");
    ...
    const tailwind_style_path_abs = dir.resolve(__dirname, "../_page-index/_tailwind/tailwind.style.css");
