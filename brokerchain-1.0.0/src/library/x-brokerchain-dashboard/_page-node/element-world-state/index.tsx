...
import { WorldStateProps, WorldStateState, init_state } from "./type.js";
...
export class WorldState extends React.Component<WorldStateProps, WorldStateState> {
    extend: Extend;

    constructor(props: WorldStateProps) {
        super(props);
    ...
    componentDidUpdate(prevProps: Readonly<WorldStateProps>, prevState: Readonly<WorldStateState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<WorldStateProps>, nextState: Readonly<WorldStateState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("NodeWorldState.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("NodeWorldState.render()");
        return render(this);
    }
}
