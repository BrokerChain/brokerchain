...
import { ChainProps, ChainState, init_state } from "./type.js";
...
export class Chain extends React.Component<ChainProps, ChainState> {
    ...
    componentDidUpdate(prevProps: Readonly<ChainProps>, prevState: Readonly<ChainState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<ChainProps>, nextState: Readonly<ChainState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("NodeChain.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("NodeChain.render()");
        return render(this);
    }
}
