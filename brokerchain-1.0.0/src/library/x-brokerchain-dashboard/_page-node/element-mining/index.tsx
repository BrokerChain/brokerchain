...
import { MiningProps, MiningState, init_state } from "./type.js";
...
export class Mining extends React.Component<MiningProps, MiningState> {
    ...
    componentDidUpdate(prevProps: Readonly<MiningProps>, prevState: Readonly<MiningState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<MiningProps>, nextState: Readonly<MiningState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("NodeMining.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("NodeMining.render()");
        return render(this);
    }
}
