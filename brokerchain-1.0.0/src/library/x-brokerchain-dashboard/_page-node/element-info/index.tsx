...
import { InfoProps, InfoState, init_state } from "./type.js";
...
export class Info extends React.Component<InfoProps, InfoState> {
    ...
    componentDidUpdate(prevProps: Readonly<InfoProps>, prevState: Readonly<InfoState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<InfoProps>, nextState: Readonly<InfoState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("NodeInfo.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("NodeInfo.render()");
        return render(this);
    }
}
