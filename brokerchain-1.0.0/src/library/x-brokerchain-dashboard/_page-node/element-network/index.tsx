...
import { NetworkProps, NetworkState, init_state } from "./type.js";
...
export class Network extends React.Component<NetworkProps, NetworkState> {
    ...
    componentDidUpdate(prevProps: Readonly<NetworkProps>, prevState: Readonly<NetworkState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<NetworkProps>, nextState: Readonly<NetworkState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("NodeNetwork.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("NodeNetwork.render()");
        return render(this);
    }
}
