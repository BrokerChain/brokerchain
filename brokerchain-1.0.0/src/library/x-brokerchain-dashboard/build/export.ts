...
export { Input as BuildInput, Output as BuildOutput } from "./type.js";
export { make_input as make_build_input, make_output_ok as make_build_output_ok } from "./tool/index.js";
...
export async function build<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-dashboard", "build");
    try {
