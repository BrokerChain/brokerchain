...
export { Input as WatchInput, Output as WatchOutput } from "./type.js";
export { make_input as make_watch_input, make_output_ok as make_watch_output_ok } from "./tool/index.js";
...
export async function watch<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-dashboard", "watch");
    try {
