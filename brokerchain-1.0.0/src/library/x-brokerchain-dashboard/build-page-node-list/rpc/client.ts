...
export async function rpc_build_page_node_list<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_build_page_node_list");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/x-brokerchain-dashboard/build-page-node-list`,
                data: input
            },
            {
