...
export { Input as RunInput, Output as RunOutput } from "./type.js";
export { make_input as make_run_input, make_output_ok as make_run_output_ok } from "./tool/index.js";
...
export async function run<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-dashboard", "run");
    try {
