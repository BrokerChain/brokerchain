...
import { watch_page_node_list as target } from "../export.js";
...
export async function handle_rpc_watch_page_node_list<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_watch_page_node_list");
