...
export class Content extends React.Component<ContentProps, ContentState> {
    ...
    shouldComponentUpdate(nextProps: Readonly<ContentProps>, nextState: Readonly<ContentState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("IndexContent.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("IndexContent.render()");
        return render(this);
    }
}
