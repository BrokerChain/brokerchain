...
export class Header extends React.Component<HeaderProps, HeaderState> {
    ...
    shouldComponentUpdate(nextProps: Readonly<HeaderProps>, nextState: Readonly<HeaderState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("IndexHeader.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("IndexHeader.render()");
        return render(this);
    }
}
