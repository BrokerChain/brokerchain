...
import { run_public as target_fun } from "./export.js";
import { rpc_run_public as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { build: boolean }) => R; fail: (err: Error) => R }): Promise<R> {
