...
import { build_page_input_phone as target } from "../export.js";
...
export async function handle_rpc_build_page_input_phone<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_build_page_input_phone");
