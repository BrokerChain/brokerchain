...
export class Root extends React.Component<RootProps, RootState> {
    ...
    componentDidUpdate(prevProps: Readonly<RootProps>, prevState: Readonly<RootState>, snapshot?: any): void {
        did_update(this, { props: prevProps, state: prevState });
    }

    shouldComponentUpdate(nextProps: Readonly<RootProps>, nextState: Readonly<RootState>, nextContext: any): boolean {
        ...
        function debug_log(...args: any[]) {
            // console.log("AttributeListRoot.shouldComponentUpdate()", ...args);
        }
    }

    render() {
        // console.log("AttributeListRoot.render()");
        return render(this);
    }
}
