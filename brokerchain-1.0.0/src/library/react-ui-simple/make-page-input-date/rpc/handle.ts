...
import { make_page_input_date as target } from "../export.js";
...
export async function handle_rpc_make_page_input_date<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_make_page_input_date");
