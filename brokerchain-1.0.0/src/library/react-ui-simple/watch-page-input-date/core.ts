...
export async function core<R>(log: Logger, input: Input, cb: Callback<R>): Promise<R> {
    ...
    await write_text_file(log, path.resolve(__dirname, "../_webroot-src/input-date/index.html"), html, {
        ok: () => {
            // ignore
        },
        fail: (err) => {
    ...
    await vite.watch(
        log,
        {
            ...
            entry_html_list: [
                {
                    name: "input-date",
                    path: path.resolve(__dirname, "../_webroot-src/input-date/index.html")
                }
            ],
            proxy_list: [
                {
