...
import { build_page_raw_textarea as target } from "../export.js";
...
export async function handle_rpc_build_page_raw_textarea<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_build_page_raw_textarea");
