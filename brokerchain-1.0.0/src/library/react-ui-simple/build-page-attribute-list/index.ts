...
import { build_page_attribute_list as target_fun } from "./export.js";
import { rpc_build_page_attribute_list as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { empty_out_dir?: boolean }) => R; fail: (err: Error) => R }): Promise<R> {
    const log = plog.sub("make_input_from_prompts");
    try {
        var v: { empty_out_dir?: boolean } = {
