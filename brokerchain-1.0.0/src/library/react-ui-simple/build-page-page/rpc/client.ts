...
export async function rpc_build_page_page<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_build_page_page");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/react-ui-simple/build-page-page`,
                data: input
            },
            {
