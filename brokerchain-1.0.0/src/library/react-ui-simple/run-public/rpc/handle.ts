...
import { run_public as target } from "../export.js";
...
export async function handle_rpc_run_public<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_run_public");
