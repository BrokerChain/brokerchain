...
export async function rpc_make_page_input_phone<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_make_page_input_phone");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/react-ui-simple/make-page-input-phone`,
                data: input
            },
            {
