...
function make_path(log: Logger) {
    const entry_module_path_abs = dir.resolve(__dirname, "../_page-page/index.js");
    ...
    const tailwind_style_path_abs = dir.resolve(__dirname, "../_page-page/_tailwind/tailwind.style.css");
