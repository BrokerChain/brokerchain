...
export async function rpc_watch_page_raw_textarea<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_watch_page_raw_textarea");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/react-ui-simple/watch-page-raw-textarea`,
                data: input
            },
            {
