...
export async function core<R>(log: Logger, input: Input, cb: Callback<R>): Promise<R> {
    ...
    await write_text_file(log, path.resolve(__dirname, "../_webroot-src/raw-textarea/index.html"), html, {
        ok: () => {
            // ignore
        },
        fail: (err) => {
    ...
    await vite.watch(
        log,
        {
            ...
            entry_html_list: [
                {
                    name: "raw-textarea",
                    path: path.resolve(__dirname, "../_webroot-src/raw-textarea/index.html")
                }
            ],
            proxy_list: [
                {
