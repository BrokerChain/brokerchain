...
export { Input as ShellInput, Output as ShellOutput } from "./type.js";
export { make_input as make_shell_input, make_output_ok as make_shell_output_ok } from "./tool/index.js";
...
export async function shell<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("pty", "shell");
    try {
