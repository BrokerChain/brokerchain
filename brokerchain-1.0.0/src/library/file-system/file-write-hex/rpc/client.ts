...
export async function rpc_file_write_hex<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_file_write_hex");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/file-system/file-write-hex`,
                data: input
            },
            {
