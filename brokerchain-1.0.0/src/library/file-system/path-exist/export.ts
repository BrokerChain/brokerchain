...
export { rpc_path_exist } from "./rpc/client.js";
export { Input as PathExistInput, Output as PathExistOutput } from "./type.js";
export { make_input as make_path_exist_input, make_output_ok as make_path_exist_output_ok } from "./tool/index.js";
...
export async function path_exist<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "path-exist");
    try {
