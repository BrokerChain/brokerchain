...
import { path_exist as target } from "../export.js";
...
export async function handle_rpc_path_exist<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_path_exist");
