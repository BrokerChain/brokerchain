...
export { rpc_chmod } from "./rpc/client.js";
export { Input as ChmodInput, Output as ChmodOutput } from "./type.js";
export { make_input as make_chmod_input, make_output_ok as make_chmod_output_ok } from "./tool/index.js";
...
export async function chmod<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "chmod");
    try {
