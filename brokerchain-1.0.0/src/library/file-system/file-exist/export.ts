...
export { rpc_file_exist } from "./rpc/client.js";
export { Input as FileExistInput, Output as FileExistOutput } from "./type.js";
export { make_input as make_file_exist_input, make_output_ok as make_file_exist_output_ok } from "./tool/index.js";
...
export async function file_exist<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "file-exist");
    try {
