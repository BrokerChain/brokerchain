...
export { rpc_unwatch } from "./rpc/client.js";
export { Input as UnwatchInput, Output as UnwatchOutput } from "./type.js";
export { make_input as make_unwatch_input, make_output_ok as make_unwatch_output_ok } from "./tool/index.js";
...
export async function unwatch<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "unwatch");
    try {
