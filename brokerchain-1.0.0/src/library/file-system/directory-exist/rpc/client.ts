...
export async function rpc_directory_exist<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_directory_exist");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/file-system/directory-exist`,
                data: input
            },
            {
