...
export { rpc_file_copy } from "./rpc/client.js";
export { Input as FileCopyInput, Output as FileCopyOutput } from "./type.js";
export { make_input as make_file_copy_input, make_output_ok as make_file_copy_output_ok } from "./tool/index.js";
...
export async function file_copy<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "file-copy");
    try {
