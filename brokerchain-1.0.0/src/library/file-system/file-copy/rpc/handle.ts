...
import { file_copy as target } from "../export.js";
...
export async function handle_rpc_file_copy<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_file_copy");
