...
export async function rpc_temp_path_resolve<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_temp_path_resolve");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/file-system/temp-path-resolve`,
                data: input
            },
            {
