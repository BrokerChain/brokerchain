...
export async function rpc_file_rename<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_file_rename");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/file-system/file-rename`,
                data: input
            },
            {
