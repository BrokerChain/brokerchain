...
import { file_write_text as target } from "../export.js";
...
export async function handle_rpc_file_write_text<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_file_write_text");
