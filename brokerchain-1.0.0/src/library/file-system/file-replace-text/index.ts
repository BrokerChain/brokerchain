...
import { file_replace_text as target_fun } from "./export.js";
import { rpc_file_replace_text as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { name: string }) => R; fail: (err: Error) => R }): Promise<R> {
