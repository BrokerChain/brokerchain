...
export { Input as DecompressInput, Output as DecompressOutput } from "./type.js";
export { make_input as make_decompress_input, make_output_ok as make_decompress_output_ok } from "./tool/index.js";
...
export async function decompress<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("zip", "decompress");
    try {
