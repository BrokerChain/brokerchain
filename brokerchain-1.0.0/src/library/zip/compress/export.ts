...
export { Input as CompressInput, Output as CompressOutput } from "./type.js";
export { make_input as make_compress_input, make_output_ok as make_compress_output_ok } from "./tool/index.js";
...
export async function compress<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("zip", "compress");
    try {
