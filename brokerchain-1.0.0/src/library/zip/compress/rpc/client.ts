...
export async function rpc_compress<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_compress");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/zip/compress`,
                data: input
            },
            {
