...
export { Input as TaskAddInput, Output as TaskAddOutput } from "./type.js";
export { make_input as make_task_add_input, make_output_ok as make_task_add_output_ok } from "./tool/index.js";
...
export async function task_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("task-queue", "task-add");
    try {
