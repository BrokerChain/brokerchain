...
export { Input as AllCycleInput, Output as AllCycleOutput } from "./type.js";
export { make_input as make_all_cycle_input, make_output_ok as make_all_cycle_output_ok } from "./tool/index.js";
...
export async function all_cycle<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("task-queue", "all-cycle");
    try {
