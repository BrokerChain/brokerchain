...
import { queue_status as target } from "../export.js";
...
export async function handle_rpc_queue_status<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_queue_status");
