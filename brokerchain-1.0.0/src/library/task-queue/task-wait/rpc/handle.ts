...
import { task_wait as target } from "../export.js";
...
export async function handle_rpc_task_wait<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_task_wait");
