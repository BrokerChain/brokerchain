...
export { Input as TaskWaitInput, Output as TaskWaitOutput } from "./type.js";
export { make_input as make_task_wait_input, make_output_ok as make_task_wait_output_ok } from "./tool/index.js";
...
export async function task_wait<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("task-queue", "task-wait");
    try {
