...
export { Input as AllStatusInput, Output as AllStatusOutput } from "./type.js";
export { make_input as make_all_status_input, make_output_ok as make_all_status_output_ok } from "./tool/index.js";
...
export async function all_status<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("task-queue", "all-status");
    try {
