...
import { all_status as target } from "../export.js";
...
export async function handle_rpc_all_status<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_all_status");
