...
export { Input as QueueRunInput, Output as QueueRunOutput } from "./type.js";
export { make_input as make_queue_run_input, make_output_ok as make_queue_run_output_ok } from "./tool/index.js";
...
export async function queue_run<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("task-queue", "queue-run");
    try {
