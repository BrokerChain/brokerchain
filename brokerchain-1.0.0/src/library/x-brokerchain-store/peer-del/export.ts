...
export { rpc_peer_del } from "./rpc/client.js";
export { Input as PeerDelInput, Output as PeerDelOutput } from "./type.js";
export { make_input as make_peer_del_input, make_output_ok as make_peer_del_output_ok } from "./tool/index.js";
...
export async function peer_del<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "peer-del");
    try {
