...
import { Input, Output, check_input, OutputNone, OutputOk } from "./type.js";
import { node_get_raw as target_fun } from "./export.js";
import { rpc_node_get_raw as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { id: string }) => R; fail: (err: Error) => R }): Promise<R> {
