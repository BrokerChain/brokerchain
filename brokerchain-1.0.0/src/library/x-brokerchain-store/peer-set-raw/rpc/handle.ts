...
import { peer_set_raw as target } from "../export.js";
...
export async function handle_rpc_peer_set_raw<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_peer_set_raw");
