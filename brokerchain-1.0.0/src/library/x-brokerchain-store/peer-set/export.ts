...
export { rpc_peer_set } from "./rpc/client.js";
export { Input as PeerSetInput, Output as PeerSetOutput } from "./type.js";
export { make_input as make_peer_set_input, make_output_ok as make_peer_set_output_ok } from "./tool/index.js";
...
export async function peer_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "peer-set");
    try {
