...
import { peer_set as target } from "../export.js";
...
export async function handle_rpc_peer_set<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_peer_set");
