...
export { rpc_node_set } from "./rpc/client.js";
export { Input as NodeSetInput, Output as NodeSetOutput } from "./type.js";
export { make_input as make_node_set_input, make_output_ok as make_node_set_output_ok } from "./tool/index.js";
...
export async function node_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "node-set");
    try {
