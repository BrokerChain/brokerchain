...
export { rpc_peer_add } from "./rpc/client.js";
export { Input as PeerAddInput, Output as PeerAddOutput } from "./type.js";
export { make_input as make_peer_add_input, make_output_ok as make_peer_add_output_ok } from "./tool/index.js";
...
export async function peer_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "peer-add");
    try {
