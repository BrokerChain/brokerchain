...
export { Input as NodeAddInput, Output as NodeAddOutput } from "./type.js";
export { make_input as make_node_add_input, make_output_ok as make_node_add_output_ok } from "./tool/index.js";
...
export async function node_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "node-add");
    try {
