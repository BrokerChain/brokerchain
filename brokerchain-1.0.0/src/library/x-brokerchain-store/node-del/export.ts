...
export { Input as NodeDelInput, Output as NodeDelOutput } from "./type.js";
export { make_input as make_node_del_input, make_output_ok as make_node_del_output_ok } from "./tool/index.js";
...
export async function node_del<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "node-del");
    try {
