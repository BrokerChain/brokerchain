...
export { rpc_upgrade } from "./rpc/client.js";
export { Input as UpgradeInput, Output as UpgradeOutput } from "./type.js";
export { make_input as make_upgrade_input, make_output_ok as make_upgrade_output_ok } from "./tool/index.js";
...
export async function upgrade<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-brokerchain-store", "upgrade");
    try {
