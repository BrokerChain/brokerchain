...
export async function rpc_start<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_start");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/node-forge/start`,
                data: input
            },
            {
