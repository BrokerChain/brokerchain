...
export { Input as StartInput, Output as StartOutput } from "./type.js";
export { make_input as make_start_input, make_output_ok as make_start_output_ok } from "./tool/index.js";
...
export async function start<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("node-forge", "start");
    try {
