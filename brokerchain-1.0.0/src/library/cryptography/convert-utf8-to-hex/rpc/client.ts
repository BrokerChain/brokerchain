...
export async function rpc_convert_utf8_to_hex<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_convert_utf8_to_hex");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/cryptography/convert-utf8-to-hex`,
                data: input
            },
            {
