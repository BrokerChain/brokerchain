...
export { Input as RandomHexInput, Output as RandomHexOutput } from "./type.js";
export { make_input as make_random_hex_input, make_output_ok as make_random_hex_output_ok } from "./tool/index.js";
...
export async function random_hex<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "random-hex");
    try {
