...
import { text_to_hex as target_fun } from "./export.js";
import { rpc_text_to_hex as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { text: string }) => R; fail: (err: Error) => R }): Promise<R> {
