...
export { Input as HashHexInput, Output as HashHexOutput } from "./type.js";
export { make_input as make_hash_hex_input, make_output_ok as make_hash_hex_output_ok } from "./tool/index.js";
...
export async function hash_hex<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "hash-hex");
    try {
