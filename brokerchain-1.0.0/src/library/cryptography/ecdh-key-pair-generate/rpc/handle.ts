...
import { ecdh_key_pair_generate as target } from "../export.js";
...
export async function handle_rpc_ecdh_key_pair_generate<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_ecdh_key_pair_generate");
