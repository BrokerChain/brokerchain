...
import { hash_text as target } from "../export.js";
...
export async function handle_rpc_hash_text<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_hash_text");
