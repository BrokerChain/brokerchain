...
export { Input as HashTextInput, Output as HashTextOutput } from "./type.js";
export { make_input as make_hash_text_input, make_output_ok as make_hash_text_output_ok } from "./tool/index.js";
...
export async function hash_text<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "hash-text");
    try {
