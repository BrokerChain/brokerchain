...
export { Input as CipherHexInput, Output as CipherHexOutput } from "./type.js";
export { make_input as make_cipher_hex_input, make_output_ok as make_cipher_hex_output_ok } from "./tool/index.js";
...
export async function cipher_hex<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "cipher-hex");
    try {
