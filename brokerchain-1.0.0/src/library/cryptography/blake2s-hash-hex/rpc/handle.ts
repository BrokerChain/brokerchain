...
import { blake2s_hash_hex as target } from "../export.js";
...
export async function handle_rpc_blake2s_hash_hex<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_blake2s_hash_hex");
