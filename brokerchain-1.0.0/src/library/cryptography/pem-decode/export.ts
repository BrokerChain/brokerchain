...
export { Input as PemDecodeInput, Output as PemDecodeOutput } from "./type.js";
export { make_input as make_pem_decode_input, make_output_ok as make_pem_decode_output_ok } from "./tool/index.js";
...
export async function pem_decode<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "pem-decode");
    try {
