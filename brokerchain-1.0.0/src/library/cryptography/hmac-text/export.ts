...
export { Input as HmacTextInput, Output as HmacTextOutput } from "./type.js";
export { make_input as make_hmac_text_input, make_output_ok as make_hmac_text_output_ok } from "./tool/index.js";
...
export async function hmac_text<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "hmac-text");
    try {
