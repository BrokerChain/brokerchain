...
import { ecdh_x25519_secret_compute as target } from "../export.js";
...
export async function handle_rpc_ecdh_x25519_secret_compute<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_ecdh_x25519_secret_compute");
