...
export async function rpc_ecdh_x25519_secret_compute<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_ecdh_x25519_secret_compute");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/cryptography/ecdh-x25519-secret-compute`,
                data: input
            },
            {
