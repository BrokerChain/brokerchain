...
import { hash_algorithm_list as target } from "../export.js";
...
export async function handle_rpc_hash_algorithm_list<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_hash_algorithm_list");
