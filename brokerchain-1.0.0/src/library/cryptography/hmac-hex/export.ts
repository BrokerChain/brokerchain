...
export { Input as HmacHexInput, Output as HmacHexOutput } from "./type.js";
export { make_input as make_hmac_hex_input, make_output_ok as make_hmac_hex_output_ok } from "./tool/index.js";
...
export async function hmac_hex<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "hmac-hex");
    try {
