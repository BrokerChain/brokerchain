...
export { Input as PemEncodeInput, Output as PemEncodeOutput } from "./type.js";
export { make_input as make_pem_encode_input, make_output_ok as make_pem_encode_output_ok } from "./tool/index.js";
...
export async function pem_encode<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "pem-encode");
    try {
