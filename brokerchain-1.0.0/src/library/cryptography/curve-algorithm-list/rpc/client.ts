...
export async function rpc_curve_algorithm_list<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_curve_algorithm_list");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/cryptography/curve-algorithm-list`,
                data: input
            },
            {
