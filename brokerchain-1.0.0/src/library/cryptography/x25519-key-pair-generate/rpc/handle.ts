...
import { x25519_key_pair_generate as target } from "../export.js";
...
export async function handle_rpc_x25519_key_pair_generate<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_x25519_key_pair_generate");
