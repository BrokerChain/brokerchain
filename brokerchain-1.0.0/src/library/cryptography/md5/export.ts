...
export { Input as Md5Input, Output as Md5Output } from "./type.js";
export { make_input as make_md5_input, make_output_ok as make_md5_output_ok } from "./tool/index.js";
...
export async function md5<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cryptography", "md5");
    try {
