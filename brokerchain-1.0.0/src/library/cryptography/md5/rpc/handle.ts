...
import { md5 as target } from "../export.js";
...
export async function handle_rpc_md5<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_md5");
