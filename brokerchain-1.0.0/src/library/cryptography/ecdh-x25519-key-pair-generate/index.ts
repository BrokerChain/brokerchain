...
import { ecdh_x25519_key_pair_generate as target_fun } from "./export.js";
import { rpc_ecdh_x25519_key_pair_generate as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: {}) => R; fail: (err: Error) => R }): Promise<R> {
