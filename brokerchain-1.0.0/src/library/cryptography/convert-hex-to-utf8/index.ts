...
import { convert_hex_to_utf8 as target_fun } from "./export.js";
import { rpc_convert_hex_to_utf8 as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { hex: string }) => R; fail: (err: Error) => R }): Promise<R> {
