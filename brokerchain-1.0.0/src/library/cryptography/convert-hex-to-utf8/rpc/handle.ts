...
import { convert_hex_to_utf8 as target } from "../export.js";
...
export async function handle_rpc_convert_hex_to_utf8<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_convert_hex_to_utf8");
