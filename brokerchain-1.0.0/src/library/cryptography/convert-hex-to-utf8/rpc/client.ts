...
export async function rpc_convert_hex_to_utf8<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_convert_hex_to_utf8");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/cryptography/convert-hex-to-utf8`,
                data: input
            },
            {
