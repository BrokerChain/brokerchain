...
export async function rpc_hex_slice_batch<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_hex_slice_batch");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/buffer/hex-slice-batch`,
                data: input
            },
            {
