...
export async function rpc_hex_reverse<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_hex_reverse");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/buffer/hex-reverse`,
                data: input
            },
            {
