...
export { rpc_hex_reverse } from "./rpc/client.js";
export { Input as HexReverseInput, Output as HexReverseOutput } from "./type.js";
export { make_input as make_hex_reverse_input, make_output_ok as make_hex_reverse_output_ok } from "./tool/index.js";
...
export async function hex_reverse<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("buffer", "hex-reverse");
    try {
