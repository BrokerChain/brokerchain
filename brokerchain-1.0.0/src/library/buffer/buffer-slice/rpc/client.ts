...
export async function rpc_buffer_slice<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_buffer_slice");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/buffer/buffer-slice`,
                data: input
            },
            {
