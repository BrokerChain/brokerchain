...
export { Input as BufferSliceInput, Output as BufferSliceOutput } from "./type.js";
export {
    make_input as make_buffer_slice_input,
    make_output_empty as make_buffer_slice_output_empty,
    make_output_ok as make_buffer_slice_output_ok
} from "./tool/index.js";
...
export function buffer_slice<R>(plog: Logger, input: InputEx, cb: Callback<R>): R {
    const log = plog.sub_library_function("buffer", "buffer-slice");
    try {
