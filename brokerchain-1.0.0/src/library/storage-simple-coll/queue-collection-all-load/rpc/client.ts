...
export async function rpc_queue_collection_all_load<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_queue_collection_all_load");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/storage-simple-coll/queue-collection-all-load`,
                data: input
            },
            {
