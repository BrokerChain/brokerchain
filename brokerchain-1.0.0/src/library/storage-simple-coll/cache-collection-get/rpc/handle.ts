...
import { cache_collection_get as target } from "../export.js";
...
export async function handle_rpc_cache_collection_get<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_cache_collection_get");
