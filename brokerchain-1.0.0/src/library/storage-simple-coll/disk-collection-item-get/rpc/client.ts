...
export async function rpc_disk_collection_item_get<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_disk_collection_item_get");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/storage-simple-coll/disk-collection-item-get`,
                data: input
            },
            {
