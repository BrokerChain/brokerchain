...
export async function rpc_collection_get_one<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_collection_get_one");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/storage-simple-coll/collection-get-one`,
                data: input
            },
            {
