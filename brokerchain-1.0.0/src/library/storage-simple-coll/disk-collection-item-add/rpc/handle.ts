...
import { disk_collection_item_add as target } from "../export.js";
...
export async function handle_rpc_disk_collection_item_add<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_disk_collection_item_add");
