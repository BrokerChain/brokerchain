...
import { cache_collection_set as target } from "../export.js";
...
export async function handle_rpc_cache_collection_set<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_cache_collection_set");
